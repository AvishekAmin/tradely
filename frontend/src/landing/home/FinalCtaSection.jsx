...
export default function FinalCtaSection() {
  return (
    <section
      id="create-account"
      className="pt-8 pb-16 lg:pt-10 lg:pb-20 relative overflow-hidden scroll-mt-16"
    >
        ...
        <div className="relative rounded-3xl border border-white/10 bg-gradient-to-b from-[#181818] to-[#101010] p-8 sm:p-14 lg:p-16 text-center space-y-8 shadow-2xl shadow-black/80 overflow-hidden">
          ...
          <div className="space-y-4 max-w-2xl mx-auto">
            ...
            <p className="text-slate-300 text-sm sm:text-base leading-relaxed">
              Practice with zero-risk capital. Master advanced limit, trailing,
              and OCO bracket orders. Understand your portfolio before
              committing real capital anywhere.
            </p>
          </div>
