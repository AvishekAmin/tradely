...
export default function RiskManagementSection() {
  ...
  const orderTypes = {
    LIMIT: {
      ...
      reservation:
        "Full cash or share quantity locked until fill or cancellation.",
      diagram: [
        {
          label: "Target Set",
          detail: "e.g. Buy @ ₹2,800.00 (Current: ₹2,940)",
        },
    ...
    STOP_MARKET: {
      ...
      diagram: [
        ...
        {
          label: "Immediate Market Order",
          detail: "Executed instantly at next available tick",
        },
      ],
    },
    STOP_LIMIT: {
      ...
      trigger:
        "Triggers a Limit Order when stop price is touched, respecting limit price as floor.",
      reservation:
        "Reserved at initiation. Prevents catastrophic gap-down fills.",
      diagram: [
        { label: "Stop Trigger", detail: "e.g. Trigger @ ₹2,750.00" },
        { label: "Limit Floor", detail: "Floor Limit @ ₹2,740.00" },
        {
          label: "Controlled Execution",
          detail: "Fills between ₹2,740 and ₹2,750 only",
        },
      ],
    },
    TRAILING_STOP: {
      ...
      trigger:
        "Stop trigger automatically ratchets upward as market makes new highs.",
      reservation:
        "Initial stop set below market; trails by fixed % or ₹ distance.",
      diagram: [
        {
          label: "Ratcheting High",
          detail: "Stock climbs from ₹2,900 to ₹3,100",
        },
        { label: "Stop Follows", detail: "Stop automatically rises with high" },
        {
          label: "Drop Trigger",
          detail: "Market reverses by trail distance -> Exit triggered",
        },
      ],
    },
    OCO: {
      ...
      trigger:
        "Take-Profit Limit leg OR Stop-Loss leg triggers. The winner executes, loser cancels instantly.",
      reservation:
        "CRITICAL: Single shared reservation. Does NOT double-reserve your position.",
      diagram: [
        { label: "Take-Profit Leg", detail: "Upper Limit @ ₹3,200.00" },
        {
          label: "Shared Reservation",
          detail: "Same 10 shares back both outcomes",
        },
  ...
  return (
    <section
      id="order-management"
      className="pt-8 pb-16 lg:pt-10 lg:pb-24 border-t border-white/[0.08] bg-[#0A0A0A] scroll-mt-16"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        <div className="text-center space-y-4 max-w-2xl mx-auto">
          ...
          <p className="text-slate-400 text-sm sm:text-base leading-relaxed">
            Tradely supports advanced order types engineered with
            server-authoritative matching and atomic reservation locks.
          </p>
        </div>
